...
:END:
#+title: doing
* move Skg README and TODO to org-roam
  merge with skg, skg outreach, ...
  This way they can link to each other.
* ONGOING skg publish
  in order of execution
** commit skg in kg
** publish kg
** to twitter?
   God the hands-off pedophile, keeping humans ignorant just to watch.

   Haha jk, obviously there's no god. But we should be similarly outraged, because we are dumb. We could radically improve by sharing knowledge graphs.
* ONGOING [[id:7106e40c-3ec9-4439-9934-aff1b60f384a][Ilya in Colombia]]
* TODO soon
** schedule [[id:7ca3f35d-d859-4577-9403-ac45ef76b5ba][cardio tests <2026-02-12 Thu>]]
   for after moving
...
* TODO ? Export personal-* repos
  to a private repo with github-navigable links?
  personal/ already is so exported.
  If doing this, be careful to distinguish 'publish' from 'export'.
...
**** enjoy being along
*** [[id:9ce71a71-77d1-4611-82fc-901b951670ef][a dating strategy could I feel passionate about]]
*** It's important to reveal in time how you feel about it when someone reveals something.
*** Surrounded By Idiots (book, on reading people)
** honor
*** Never shake hands.
    I have hurt others that way, and I have been hurt that way,
    and never saw it coming.
*** to explain to someone what they were to you
...
**** Dreaming is cool as the time before writing.
     ...
     :END:
*** want to share widely, feels wrong
**** Death, God, etc. are transition fantasies. Maybe the richest experience is to know each others'. (Mine are strange, I can say that for sure.)
*** Today <2026-01-10 Sat> I mindmapped, and when finished I felt like it had been engagement with reality, inc. my practical social reality.
    Throughout the process, I doubted its productivity,
    but after having done it I feel cautiously hopeful.
*** Polyanna

...
* review my own data
** DONE review git log
   git log -p --diff-filter=d
*** CAN'T personal-most: too much
*** DONE personal-ish: all
*** DONE personal-proc: all
*** DONE personal: back through to Aug 21 (not inclusive)
*** DONE public: back through to Aug 21 (not inclusive)
** DONE review some files
*** review 'doing'
*** review [[id:90855b17-b9cb-4e11-bdd0-0be9781d6a78][pressing]] and [[id:066400ef-cc2d-4504-aad8-31180943684b][priorities]]
** DONE transfer from phone
** TODO commit latest changes
* doing / pressing
  :PROPERTIES:
...
* ONGOING Get immigration lawyer contact from Jeremy.
* ======= ABOVE: CRITICAL =======

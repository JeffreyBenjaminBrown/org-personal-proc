...
* mal(eficient?), having avoided evil but not its appearance
* Ask talk invitees for time preferences.
* present Skg like to Haskellers, ask for architectural opinions
* cancel Tinder?
* doing / pressing
  :PROPERTIES:

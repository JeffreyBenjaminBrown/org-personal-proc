...
** sell couch
*** post ad, give to Jeremy
** moving out sale
*** Offer the stuff minus shipping, they agree that I can later pay to ship it back to me (and try to take care of it).
** money & organization
*** [[id:6f28dbdc-e81d-4691-adfc-447ca8c20b85][my financial history]]
*** Paying Yeni's SS is relevant to my taxes in Colombia.
*** Keep records of everything I pay Yeni, and everything she works.
* with others
** I should go to Colorado.
** to Deb
...
* [[id:2c400b23-7036-42e3-b521-ea0edf70c5ac][A Philosophy of Software Design, book by John Ousterhout]]
* social skills
...
** ONGOING AI prompt for topics
 I have a program with different kinds of data in different systems, and some systems can affect others. What are some CS topics relevant to that? If you can, please aim for something like orthogonality between them -- I'm looking for a sparse basis of topics from I can look up neighbors of those topics to roughly cover the relevant space of ideas, if that makes sense.
...
*** [[id:3ebc94dc-9ba5-4dfd-9ebd-9f9960fd790d][Maryland Dec 2025, what I remember]]
** backup

...
#+title: doing
* TODO Tell V & M when
* ONGOING Lorena's place : bring tape measure
* ONGOING moving
** TODO buy supplies
*** post-it notes for movers
** TODO Write that guy about the chairs so he has time to pick them up.
*** Lorena sends contact info for a chair guy.
** TODO URGENT: Guitar to Felipe | Valentina
** DONE URGENT reputation of storage space
** TODO HARD $$$ special $$ items | deal with movers
*** table
**** Moderatto: Get those chairs, disassemble the table, ask about putting the couch sideways.
*** chairs
*** dishwasher, dryer to Lorena
*** they wrap couch, bed
** have snacks, drinks for the movers
** tip the movers
** "moving blankets"
** have heavy-duty garbage bags ("contractor bags")
** work gloves prevent hands drying on cardboard
** ? closet box
** plastic wrap over tops of liquid containers
** There exists a "tape gun".
** be able to label the boxes.
** Twist bicycle handlebars.
** try loading the metal shelves
Can everything delicate fit on them?
** get packing paper
Make packing kitchen easy.
** warn/reserve with neighbors
** wrap nightstand|dresser in stress wrap
** light things in big boxes, heavy in small
** strong boxes would pay for themselves if they saved one thing from breaking
** get insurance
** confirm with movers day before
** check reputation of storage company I chose
** find movers
*** Can I get in-person estimates?
*** reputation & experience
** cancel Claro, Enel, Vanti, Acueducto
** from phone
*** ? how to process
**** write in words or space
***** "It's easier to do this physically than to track things electronically."
*** give away
**** "Do you want to hold
some paintings for me for probably at least the rest of 2025?"
*** Sell
**** TV
*** To keep somewhere else
*** To carry
*** rooms
**** closet room : almost done, shower
*** Separate my things
*** To give away, worth announcing
**** Instances
***** Electronics
***** Monitor
**** Strip identifying information from electronics before giving away
** moving & my stuff & Rocio + Juan
*** sorting stuff into futures
**** Living room | suitcases :: Carry.
At end of day, move "give away" from closet room to downstairs.
**** Left in place | boxed :: Store.
**** Closet room | in place :: Give away.
*** How to tell Juan and Rocio about the door.
Film it. Demonstrate that it is good. Explain that a few times a year I have seen a little water come in through it during a heavy rain. When I saw that -- and maybe I didn't always see it -- I would mop it up with a towel. I was always afraid the water would get under the wood and damage it, but it never did.
** [[id:d5adfeeb-c3f1-4d66-98c7-235e16af4f15][leaving Pablo VI]]
*** Olio -- app to give stuff
*** storage
    contacting
**** M3 Storage : I am renting
     57 321 7812754
...
*** measure my stuff
*** San Luis (Bogotá neighborhood) : convient location, quiet
*** places to live
**** Buenos Aires
**** San Miguel de Allende, Mexico
**** Cuenca, Ecuador
** [[id:4387519e-a9a5-4f04-898a-8fde955f6395][overwhelm & mysterious unwillingness ::? entangled? why?]]
...
* ONGOING [[id:26328ef3-4e21-4b2f-af34-c35ec3ddbab9][extending tourist visa]]
* ONGOING being alive
** [[id:a7fb848b-53e8-49e9-91b6-c3c73c83876b][regular payments]]
** Plan with Sid, Bran, uncles, Josh, Nicole, Phil.
** schedule [[id:7ca3f35d-d859-4577-9403-ac45ef76b5ba][cardio followup]]
   for after moving
     (probably unavailable before anyway)
*** scan results must be on colsanitas.com
** ? invest remaining 20k
** outreach
*** write people
...
*** [[id:c0cc501a-7571-49fd-a9ce-f15925a187b5][review whatsapp, email]]
*** money & organization
...
* ONGOING [[id:2d0f9b52-8cbb-404d-9b69-b931dce4c198][sell the Paulo VI apartment]]
** [[id:f4f9a984-31e2-4bad-9442-b65ecd800fce][Paulo VI condo]]
* hard to act on, maybe good to publish
** {inheritors, irrational collectors} defeat some of the point of prices.
Prices allocate resources to whoever is most willing to pay.
There is some correlation between
willingness to pay and likelihood to use it well.
But targeted giving is likely to direct the resource better
if there are lots of
{inheritors, irrational collectors}.
* I am drawn to yet {? so far, ultimately, mostly} reject certain own behaviors.
like outreach
* If it were axiomatic that this is impossible.
* to public
** karma & time
*** Chop wood, carry water: What changes internally.
After enlightenment, the same actions,
but now believing in yourself|society,
recognizing (or having faith in?)
the karmic perfection of slowly grinding gears.
* to read about how to read|write|graph
** ONGOING search terms
how read write knowledge graph
* [[id:7c187ba0-b2fe-440d-8588-cf55ea80f0ea][Principles of (Microtonal) Harmony]]
* Evil-looking spirit emperor.
Truly living, thinking about higher things, weirdly
{dictating, magically recognizing new natures of} conditions.
Floating. Meditating. Skipping stones over a lake.
* an art about brackets
"an art" is better rep'd in skg
** The kind of bracket used is not important if it carries good labels.
** ()s have unity.
** {}s are setlike.
** ? What about sequences?
Still not there yet.
** ".." for omissions
Distinguish unknown omissions?
** "?" for uncertainty
** laughing
...
* ? add sweet potato to soup
* cook :: roast peppers, squash, carrots, onions
* what is squash?
not a root, not aseed, ...
* ? guitar interface
Global default (overrides? overridden by?) per-string defaults,
sevn boolean values always present (as opposed to being Maybe|Optional).
...
* backup data, then dogfood skg again
* social
** ? Do I owe Isabel an explanation.
